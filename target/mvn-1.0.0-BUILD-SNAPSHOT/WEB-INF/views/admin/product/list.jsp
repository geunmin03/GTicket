							...
							<div class="box-body">
								<table class="table table-striped text-center">
									...
									<c:if test="${empty productList}">
										<tr>
											<td colspan="10"> 
												<p style="padding:50px 0px; text-align: center;">등록된 상품이 존재하지 않습니다.<td colspan="10"> 
									...
									<c:forEach items="${productList}" var="productVO">
										<tr>
											...
											<td class="col-md-1" ><fmt:formatNumber  value="${productVO.pdt_price - productVO.pdt_discount}" pattern="###,###,###" /></td>
											<td class="col-md-2">${productVO.pdt_company}</td>
											
											<!-- 상품 전시(보임/숨김)기능 -->
											<td><input name="amount_${productVO.pdt_num}" type="number" style="width:80px; height:34px; padding-left:5px;" min="1"  value="${productVO.pdt_amount}" /></td>
											<td>
