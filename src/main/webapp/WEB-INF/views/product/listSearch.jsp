      ...
      <!-- /.col-lg-3 -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li>
						<i class="fa fa-dashboard"></i>${cg_name}</a>
					</li>
				</ol>
			</section>
					...
					<ul class="new_arrivals_list row">
						...
						<div class="col-lg-4 col-md-6 mb-4" >
							${productVO.pdt_num}
							<div class="thumnail">
								<a href="/product/read${pm.makeSearch(pm.cri.page)}&pdt_num=${productVO.pdt_num}">
									<img src="/product/displayFile?fileName=${productVO.pdt_img}" >
								</a>
							</div>
							<div class="description">
								<a href="/product/read${pm.makeSearch(pm.cri.page)}&pdt_num=${productVO.pdt_num}" >${productVO.pdt_name}</a>
								<p>소매가: <fmt:formatNumber value="${productVO.pdt_price}" pattern="###,###,###" />원<br>
